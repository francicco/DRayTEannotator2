...
def write_evidence_tsv(families, results, outpath):
    ...
    fields = [
        ...
        "structural_type",
        "tir_tsd_element",
        "structural_superfamily_hint",
        "structural_superfamily_confidence",
        "tsd_present",
        "tsd_len",
        "tsd_seq",
        "tsd_support",
    ...
    with open(outpath, "w") as out:
        ...
        for f in families:
            ...
            writer.writerow({
                ...
                "score": result["score"],
                "original_header": f.original_header,
                ...
                "tir_len": f.tir_len,
                "tir_identity": f.tir_identity,
                "tir_confidence": f.tir_confidence,
                "tir_5p_motif": f.tir_5p_motif,
                "tir_3p_motif": f.tir_3p_motif,
                "tir_terminal_motif": f.tir_terminal_motif,
                "tir_grade": f.tir_grade,
                "structural_type": f.structural_type,
                "tir_tsd_element": f.tir_tsd_element,
                "structural_superfamily_hint": f.structural_superfamily_hint,
                "structural_superfamily_confidence": f.structural_superfamily_confidence,
                "tsd_present": f.tsd_present,
                "tsd_len": f.tsd_len,
                "tsd_seq": f.tsd_seq,
                "tsd_support": f.tsd_support,
